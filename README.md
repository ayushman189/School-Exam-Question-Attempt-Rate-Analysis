# School-Exam-Question-Attempt-Rate-Analysis
Statistics minor project analyzing question-wise attempt rates using Python Pandas and visualization.

# School Exam Question Attempt Rate Analysis

## Project Overview
This project analyzes question-wise attempt rates of students in a school examination.
The goal is to identify the difficulty level of questions based on how many students attempted them.
...
- Columns include:
  - Question number
  - Number of students who attempted the question
...
2. Calculated attempt rate percentage for each question
3. Computed mean attempt rate
